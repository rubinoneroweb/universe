...
class ScenesControllerTest < ActionController::TestCase
  ...
  test "should create scene" do
    assert_difference('Scene.count') do
      post :create, scene: { desc: @scene.desc, image: @scene.image, location_id: @scene.location_id, short_desc: @scene.short_desc }
    end
  ...
  test "should update scene" do
    patch :update, id: @scene, scene: { desc: @scene.desc, image: @scene.image, location_id: @scene.location_id, short_desc: @scene.short_desc }
    assert_redirected_to scene_path(assigns(:scene))
  end
